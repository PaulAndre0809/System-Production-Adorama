"""Fix VBA code in both workbooks."""
...
def fix_workbook(path_str):
    ...
    for i in range(1, wb.VBProject.VBComponents.Count + 1):
        ...
        if comp.CodeModule.CountOfLines > 0:
            ...
            code = code.replace(
                '"SMSCampaignsTable[Jira Link]," & _\r\n        "SMSCampaignsTable[ClickUp Link]," & _\r\n        "SMSCampaignsTable[Bluecore/Attentive Link])," & _',
...
if __name__ == "__main__":
    fix_workbook(r"Production Tracker\Email & SMS Campaign Tracker_backup.xlsm")
